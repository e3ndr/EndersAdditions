package xyz.e3ndr.endersadditions.world;
...
public class Oregen implements IWorldGenerator {
    ...
    /**
     * this.addOreSpawn(block, world, random, posX, posZ, maxX, maxZ, maxVeinSize,
    ...
    private void generateSurface(World world, Random random, int x, int z) {
        this.addOreSpawn(Registry.blockMagicOre, world, random, x, z, 16, 16, 8, 16, 1, 256);
        this.addOreSpawn(Registry.blockSaltOre, world, random, x, z, 16, 16, 8, 8, 1, 256);
        this.addOreSpawn(Registry.blockRubyOre, world, random, x, z, 16, 16, 4, 8, 12, 36);
    }
