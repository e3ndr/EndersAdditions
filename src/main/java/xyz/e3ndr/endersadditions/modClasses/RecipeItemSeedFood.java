package xyz.e3ndr.endersadditions.modClasses;
...
public class RecipeItemSeedFood extends ItemFood implements IPlantable {
    ...
    public RecipeItemSeedFood(
        int parHealAmount, float parSaturationModifier,
    ...
    public boolean onItemUse(
        ItemStack parItemStack, EntityPlayer parPlayer,
        ...
        // check if player has capability to edit
            ...
            if (parWorld.getBlock(parX, parY, parZ).canSustainPlant(
                parWorld,
                parX, parY, parZ, ForgeDirection.UP, this
            ) && parWorld
