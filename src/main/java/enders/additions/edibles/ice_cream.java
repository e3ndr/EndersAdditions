...
public class ice_cream extends ItemFood {
    public ice_cream(int par1, int par2, float par3, boolean par4) {
    	super(par1, par2, par4);
        this.setAlwaysEdible();
		setUnlocalizedName("EndersAdditions" + "_" + "ice_cream").setMaxStackSize(64);	
		setCreativeTab(endersadditions.tabEnder);
		setTextureName("endersadditions" + ":" + "ice_cream");
    }
